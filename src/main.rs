...
use api::{
    ...
    api_add_technique_to_collection, api_approve_user, api_assign_collection,
    api_bump_last_seen, api_claim_invite, api_create_collection, api_delete_collection,
    ...
    api_self_register, api_set_student_graduated, api_update_collection, api_update_profile,
    ...
    rocket::build()
        ...
        .mount(
            ...
            routes![
                ...
                api_add_technique_to_collection,
