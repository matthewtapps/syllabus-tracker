...
use api::{
    ...
    api_assign_collection, api_assign_techniques, api_bump_last_seen, api_change_password,
    api_claim_invite, api_create_and_assign_technique, api_create_collection, api_create_tag,
    api_create_technique_in_collection, api_delete_collection, api_delete_tag, api_get_all_tags,
    api_get_collection, api_get_collection_students, api_get_collections, api_get_invite,
    ...
    api_self_register, api_set_student_graduated, api_update_collection,
