...
use api::{
    ...
    api_get_students, api_get_students_page, api_get_technique_tags,
    api_get_unassigned_techniques, api_invite_user,
    ...
    let mut rocket = rocket::custom(figment)
        ...
        .mount(
            ...
            routes![
                ...
                api_list_syllabus_student_rows,
                api_syllabus_stats,
                api_create_syllabus,
                api_get_syllabus,
                api_update_syllabus,
