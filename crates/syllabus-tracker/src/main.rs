...
use api::{
    ...
    api_create_collection, api_create_library_technique, api_create_tag,
    api_create_technique_in_collection, api_delete_attempt,
    ...
    api_pin_technique, api_promote_technique_to_global, api_recent_attempts, api_register_user,
    api_remove_tag_from_technique, api_remove_technique_from_collection,
    api_request_password_reset, api_reset_user_claim, api_self_register, api_archive_student, api_set_student_graduated,
...
use camps::{
    api_add_camp_technique, api_add_camp_technique_video, api_archive_camp, api_camp_feed,
    api_create_camp, api_create_camp_technique, api_get_camp, api_list_camps,
    api_list_camp_technique_videos, api_list_camp_videos, api_promote_pinned_to_camp,
    ...
    let mut rocket = rocket::custom(figment)
        ...
        .mount(
            ...
            routes![
                ...
                api_create_library_technique,
                api_promote_technique_to_global,
