...
use videos::{
    ...
    api_set_video_student_visibility, api_student_watch_activity, api_thread_video_reply_link,
    api_thread_video_reply_upload, api_update_video,
        ...
        rocket = rocket
            ...
            .mount(
                ...
                routes![
                    ...
                    api_thread_video_reply_upload,
                    api_video_status,
                    api_video_link,
                    api_thread_video_reply_link,
