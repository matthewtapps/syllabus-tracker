...
use api::{
    api_add_tag_to_technique, api_add_techniques_to_syllabus, api_approve_user,
    api_assign_syllabus, api_assign_techniques, api_attempt_heatmap, api_attempt_sparkline,
    api_attempt_summary, api_change_password, api_claim_invite,
    api_create_and_assign_technique, api_create_attempt, api_create_syllabus, api_create_tag,
    api_create_technique_in_syllabus, api_delete_attempt, api_delete_syllabus, api_delete_tag,
    api_get_all_tags, api_get_syllabus, api_get_syllabus_students, api_get_syllabuses,
    ...
    api_remove_tag_from_technique, api_remove_technique_from_syllabus,
    api_request_password_reset, api_reset_user_claim, api_self_register,
    api_get_student_feed, api_list_pinned_techniques, api_pin_technique, api_unpin_technique,
    api_set_footage_submitter, api_set_student_graduated, api_set_student_rank,
    api_update_attempt, api_update_syllabus,
    ...
    let mut rocket = rocket::custom(figment)
        ...
        .mount(
            ...
            routes![
                ...
                api_set_footage_submitter,
                api_get_student_feed,
                api_list_pinned_techniques,
                api_pin_technique,
                api_unpin_technique,
                ...
                api_update_syllabus,
                api_delete_syllabus,
                api_add_techniques_to_syllabus,
                api_create_technique_in_syllabus,
                api_update_library_technique,
                api_remove_technique_from_syllabus,
                api_get_syllabus_students,
                api_assign_syllabus,
